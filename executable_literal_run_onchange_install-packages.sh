...
# Install packages
sudo apt install git 7zip telegram-desktop cinnamon tmux vlc nicotine smplayer chromium neovim quodlibet qbittorrent snapd gimp libreoffice-writer libreoffice-calc
